<template>
    <div>
        <navigator></navigator>
        <div class="container lg:max-w-screen-lg mx-auto px-6 py-8 sm:py-16 md:py-24 leading-normal">
            <div class="mb-12">
                <h1 class="text-5xl text-center font-bold mb-5">ShoLC Privacy Policy</h1>
                <p class="text-opacity-80 text-gray-400 leading-loose py-3">Effective Date: December 4th, 2021</p>
                <p>
                    Welcome to ShoLC. This Privacy Policy describes the policies and procedures of ShoLC,
                    Inc. (“ShoLC”, “we” or “us”) on the collection, use, security and disclosure of personal information
                    about
                    you
                    on https://sho.lc (the “Site”) and the services, features, content or applications offered by ShoLC
                    (collectively with the Site, the “Services”). It also describes your choices regarding use,
                    access and correction of your personal information.
                </p>
                <h3 class="font-bold uppercase mt-3 mb-1">Scope</h3>
                <p>This Privacy Policy covers the treatment of the personal information gathered by ShoLC when you use
                    or access
                    the Services, or when you view or interact with a ShoLC link (either our bit.ly links of one of our
                    branded
                ...
                <p> ShoLC may collect personal information about you as described in this Privacy Policy when you (i)
                    register
                    for the Site and the Services, through your user account with ShoLC, including registering through a
                    third-party social networking service (your “Account”), (ii) use the Services, or (iii) view or
                    interact
                    with a ShoLC link (either our bit.ly links or one of our branded domains) on a third-party website.
                    We
                ...
                <p>When you create an Account, we may collect personal information from you, such as your name, phone
                    number,
                    company name, industry, job title, company size and email address. If you create an Account using
                    your login
                    from a third-party account, such as Google, Facebook or Twitter, we will access and collect the
                    personal
                    information about you that the third-party account provides (which is based on your privacy settings
                    with
                    the third-party account), so that you can log into your Account with us. We use your contact
                    information to
                    send you information about our Services and communicate with you about your Account, your activities
                    on our
                    Site and Services and policy changes. You may unsubscribe from receiving certain types of these
                    messages
                ...
                <p>One feature of the Services is the ability to create shortened uniform resource locators (URLs) of
                    websites
                    (“ShoLC Link” or “Bitlinks”). Users can create ShoLC Links without registering for an account. When
                    you
                    create a ShoLC Link, ShoLC collects and stores both the original URL and the shortened URL and, if
                    you are
                    logged in to your Account, we will associate that information with your Account. ShoLC also collects
                    and
                    stores your IP address, your location, which we derive from your IP address, the time and date on
                    which you
                ...
                <p>ShoLC automatically collects personal information about the interaction (such as clicks or views)
                    with every
                    ShoLC Link created through the Services (either our bit.ly links or one of our branded domains) on a
                    third-party website. This information includes, but is not limited to: (i) the IP address and
                    location
                    derived from the IP address; (ii) the referring websites or services; (iii) the time and date of
                    each
                    access; (iv) device settings, such as browser type, operating system, and language; (v) cookies, as
                    described below, and mobile advertising identifiers and (v) information about sharing of the ShoLC
                    Link on
                    Third Party Services such as Twitter and Facebook (collectively, “ShoLC Link Metrics”). As described
                    in this
                    policy, we use ShoLC Link Metrics to provide the Services, to understand and analyze how our
                    Services are
                    used and to identify trends, and to detect, deter and prevent malicious, fraudulent or unlawful
                    activity.
                ...
                <p>When you visit the Site, we automatically collect (i) your IP address and location derived from the
                    IP
                    address; (ii) the referring websites or services; (iii) the time and date of each access; (iv)
                    device
                    settings, such as browser type, operating system, and language; and (v) cookie information. This
                    type of
                ...
                <p>Some features of the Services allow you to share your content and ShoLC Links through your accounts
                    with
                    other companies such as Facebook and Twitter. If you choose to connect ShoLC to such Third Party
                    Services,
                    we may collect information related to your use of those Third Party Services, such as authentication
                    tokens
                    that allow us to connect to your Third Party Service accounts. We will ask you for permission before
                    you
                    authorize our collection of this information. We will only use that information for the specific
                    reason for
                ...
                <p>ShoLC cookies also allow ShoLC to track when you have clicked on a ShoLC Link. Each click of a ShoLC
                    ...
                    and
                    associated with ShoLC. We may associate the unique identifier in our cookies with the other
                    information we
                ...
                <p>We partner with third parties to track utilization and behavior on our websites, display advertising
                    ...
                    web
                    beacons, pixel tags or similar technologies in order to provide you advertising based upon your
                    browsing
                ...
                <p>You may ask ShoLC not to associate your web browser or IP address with visits to the ShoLC.com
                    website or
                    ShoLC Links that you create or click by clicking on the appropriate links below. If you would like
                    to
                    opt-out of the ShoLC Links, please click on the opt-out choice for ShoLC Links below. This will
                    install a
                    cookie on your browser that instructs our servers not to associate your IP address and browser with
                    ShoLC
                    Links you create, click or view. If you clear your cookies in your browser, you will need to click
                    on the
                    opt-out choice again after each time you clear your cookies. To be clear, these cookie-based
                    opt-outs must
                    be performed on each device and browser that you wish to have opted-out. Cookie-based opt-outs are
                    not
                    effective on mobile applications. However, on many mobile devices, application users may limit
                    tracking via
                    their device settings. Please note that if you use these opt-out mechanisms, will still
                    automatically
                ...
                <ul>
                    ...
                    <li> provide services to our customers to allow them to understand how you interact with our
                        Services and to
                        help detect, deter and prevent malicious, fraudulent or unlawful activity,
                    </li>
                ...
                <p>We may use the information we collect to make inferences that a unique individual has created or
                    interacted
                    with ShoLC links on different devices so that we can to detect, deter and prevent malicious,
                    fraudulent or
                    unlawful activity and analyze how users use our Services. For example, if you created a ShoLC link
                    on a
                    computer connected to your residential WiFi network, and you soon thereafter clicked on a ShoLC link
                    on a
                ...
                <p>We also may use personal information to pursue legitimate interests, such as direct marketing,
                    research
                    (including marketing research), network and information security, prevention of fraudulent,
                    malicious and
                ...
                <p>Where permitted by law, if you register a ShoLC Account with an email address on a domain owned by an
                    ...
                    we may
                    share your email address and information about your Account, such as the number of links you have
                    created,
                ...
                <p>We may share the personal information we collect as described in this Privacy Policy with our
                    customers. When
                    you create a ShoLC Link of one of our enterprise customer’s sites, the enterprise customer is able
                    to view
                    the unshortened original URL, the date and time the ShoLC Link was created, the location where it
                    was
                    created as derived from your IP address, and aggregated information about clicks and views of the
                    ShoLC
                    Links, including the number of times the ShoLC Link was shared, whether or not it was viewed,
                    comparison of
                    that ShoLC Links performance to that of all ShoLC Links pointing to the same content, whether others
                    are
                    sharing a ShoLC Link to the same content, geographic regions where the content is being viewed, and
                ...
                <p>When creating a ShoLC Link, you can share that ShoLC Link through Third Party Services. Any
                    information that
                    you elect to distribute through Third Party Services, such as a social network post you create, may
                    then
                    become accessible to users of those services. You can also access other Third Party Services through
                    the
                    Services, for example by clicking on links in the Statistics page for a ShoLC Link. We recommend
                    that you
                    review the terms of services and privacy policies of such Third Party Services that you access
                    through the
                ...
                <p>We may employ and contract with third parties to perform certain tasks on our behalf and under our
                    direction
                    (our “Service Providers”). We may need to share information about you with our Service Providers in
                    order to
                    provide our product with research and analytics on user behavior and to provide advertising products
                    and
                    services to users, to process payments, and to provide email marketing and support services. Our
                    agreements
                ...
                <p>ShoLC may access, read, preserve, and disclose any information it collects when it has a good faith
                    ...
                    request,
                    including process from a governmental law enforcement or national security agency, (ii) enforce the
                    Privacy
                    Policy or Terms of Service, including investigation of potential violations hereof, (iii) detect,
                    deter,
                    prevent or otherwise address malicious, fraudulent or unlawful activity, (iv) respond to user
                    support
                    requests, or (v) protect the rights, property or safety of ShoLC, its users and the public. This
                    includes
                ...
                <p>ShoLC, Inc. participates in and has certified its compliance with the EU-U.S. Privacy Shield
                    Framework and
                    the Swiss-U.S. Privacy Shield Framework. We are committed to subjecting all personal data received
                    from
                    European Economic Area (EEA) member countries and Switzerland, respectively, in reliance on each
                    Privacy
                ...
                <p>Please direct any inquiries or complaints regarding our compliance with the Principles to the point
                    ...
                    concern that
                    we have not addressed satisfactorily, please contact our U.S.-based third-party dispute resolution
                    provider
                ...
                <p>ShoLC endeavors to protect the information it collects about its users using industry-standard
                    ...
                    impenetrable and
                    ShoLC does not guarantee or warrant that such measures will prevent unauthorized access to the
                    information
                    about you that is stored by ShoLC. In the event we experience a breach of security, we will promptly
                    notify
                ...
                <p>ShoLC acknowledges that you have the right to access your personal information that we collect and
                    ...
                    your
                    personal information by logging into your Account. Once logged in to your account, you will be able
                    to view
                    a history of the URLs you have shortened and the metrics pages for those URLs. You can request a
                    complete
                    copy of the personal information we store about your account by clicking the Request GDPR SAR Report
                    button
                    in your Account Settings. For more information on how to request access to your information, please
                    see our
                    help article. You can delete your Account at any time through your Account settings page. If you
                    delete your
                    Account, you will no longer be able to access or use the Services. If you have an Account but are
                    unable to
                    access it, you can contact us at support@sho.lc. We will respond to your request within a reasonable
                    timeframe. If you are a resident of the EEA or Switzerland, you have the right to ask that your
                    personal
                    data be corrected, updated, or erased. You may also have the right to object to, or request that we
                    restrict, certain processing. If you would like to exercise any of these rights, you may contact us
                    as
                ...
                <p>Please note that in the interest of ensuring that existing ShoLC Links continue to function for all
                    ...
                    Account
                    is deleted), and any shortening and sharing activity that has already occurred on your Account also
                    cannot
                ...
                <p>ShoLC may amend this Privacy Policy from time to time. If we make material changes in the way we
                    collect or
                    use information, we will notify you by posting an announcement on the Services or sending you an
                    email, and
